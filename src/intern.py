...
image_url = "https://m.media-amazon.com/images/I/417SThj+SrL.jpg"
pixel_values = load_image(requests.get(image_url, stream=True).raw, max_num=12).to(torch.bfloat16).cuda()
